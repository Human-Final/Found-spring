    ...
    const I = {
        ...
        clip: `<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>`,
        ...
        upload: `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>`,
        ...
        pencil: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>`,
    ...
    const icons = [I.pkg, I.search, I.bell, I.pencil];

    cards.forEach((card, index) => {
        if (icons[index]) {
            // 기존 글자 앞에 아이콘만 쏙 끼워 넣습니다.
            card.insertAdjacentHTML('afterbegin', `<span class="icon-wrap">${icons[index]}</span> `);
        }
    });
    ...
    if (headerTitle) {
        // I.pin 아이콘을 글자 앞에 삽입
        headerTitle.insertAdjacentHTML('afterbegin', `<span class="header-icon">${I.pin}</span> `);
    }
});